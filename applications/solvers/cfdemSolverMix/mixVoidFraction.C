 ...
 * @note Corona Point 是在以网格中心为中心, 半径为 corona 的球面上, 距离颗粒中心最远的点
...
/*
 * @brief 计算距离系数
 * @note 对任意一个网格, 如果网格中心 c 在颗粒内部, 但是它的某个角点 p 不在颗粒内部,
