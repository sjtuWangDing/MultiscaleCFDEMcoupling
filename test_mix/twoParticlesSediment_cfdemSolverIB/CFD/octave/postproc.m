...
h = plot(particle_pos_1(:, 1), 0.01 * particle_pos_1(:, 4), '*',
         particle_pos_2(:, 1), 0.01 * particle_pos_2(:, 4), '+');
...
figure(2)
h = plot(particle_vel_1(:, 1), 0.01 * particle_vel_1(:, 4), '*',
         particle_vel_2(:, 1), 0.01 * particle_vel_2(:, 4), '+');
set(h,'LineWidth', linienstaerke, 'MarkerSize', MarkerGroesse);
set(gca, 'FontSize', 12)
